...
8.  **Configure your workspace.** In the Visual Studio Team Explorer on
    ...
    successfully."
9.  **Set your time zone.** In order to set your Visual Studio account
    to display times in the proper time zone, click on your name near
    the upper right-hand corner of the Visual Studio page in your web
    browser, and select "My profile". Then on the left, click the "Edit
    profile" button. Then near the top left, click on "Preferences". In
    the "Time zone" box, select "(UTC-06:00) Central Time (US &
    Canada)". Then click the "Save changes" button.
...
<span class="small">Last modified: Wed Aug 10 03:49:05 CDT 2016</span>
