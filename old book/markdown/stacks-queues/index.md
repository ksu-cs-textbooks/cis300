...
1.  [Introduction to Stacks](/~rhowell/DataStructures/redirect/stacks)
2.  [Implementing Undo and Redo for a
    **TextBox**](/~rhowell/DataStructures/redirect/undo-redo)
3.  [Implementing a Stack](/~rhowell/DataStructures/redirect/stack-impl)
4.  [Introduction to Queues](/~rhowell/DataStructures/redirect/queues)
5.  [Implementing a Queue](/~rhowell/DataStructures/redirect/queue-impl)
