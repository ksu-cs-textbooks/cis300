...
1.  [Dialogs](/~rhowell/DataStructures/redirect/dialogs)
2.  [Simple Text File
    I/O](/~rhowell/DataStructures/redirect/simple-text-file-io)
3.  [Exception Handling](/~rhowell/DataStructures/redirect/exceptions)
4.  [Advanced Text File
    I/O](/~rhowell/DataStructures/redirect/advanced-text-file-io)
5.  [Other File I/O](/~rhowell/DataStructures/redirect/other-file-io)
...
cotrols on the GUI, and processes that information. It may then provide
...
however. For example, other mechansims such as *dialogs* - secondary
